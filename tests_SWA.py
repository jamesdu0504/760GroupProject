    ...
    for dataset in datasets:
        ...
        for sigma_min in datasets[dataset][1:]:
            ...
            for k_freq in [10, 30, 50]:
                ...
                #Plot support graphs
                dual_support_graph_distribution(freq_model, freq_model_sanitized, sigma_model, dataset+"_SWA_"+str(sigma_min)+"_"+str(k_freq))
                ...
                new_row = {'Model': dataset,
                           ...
                           'Number of FI containing an element of S after SWA': num_FI_containing_S_RPS,
